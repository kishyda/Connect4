...
public class Main {
    public static void main(String[] args) {
        ...
        // boolean p2p = false;
        // int cpuLevel = 1;
        // Game game = new Game(p2p, cpuLevel); // p2p flag=false, 1=hard level 0=easy
        ...
        // {
        // Move move = new Move(YOUR_GET_ROW, YOUR_GET_COL); // YOUR MOVE ROW/COL GETTER
        ...
        // } else if (!p2p && game.activePlayer == 1) { // COMPUTER PLAYER STEP, it will
        // game.step(game.activePlayer);
        // game.activePlayer = (game.activePlayer + 1) % 2;
        // }
        // }
        // Public utility methods
        ////game.board.getBoard(); //get board (public)
	////game.board.getWinner(); //get winner (public)
